...
export const messages = {
  ja: {
    ...
    software: {
      ...
      password: "管理者パスワード", passwordRequired: "管理者パスワードを入力してください。",
    ...
    settings: {
      ...
      updatePassword: "管理者パスワード", updatePasswordRequired: "管理者パスワードを入力してください。", updateHelp: "更新中はServer・Agentが再起動し、一時的に接続できなくなります。",
  ...
  en: {
    ...
    software: {
      ...
      password: "Administrator password", passwordRequired: "Enter the administrator password.",
    ...
    settings: {
      ...
      updatePassword: "Administrator password", updatePasswordRequired: "Enter the administrator password.", updateHelp: "The Server and Agent will restart during the update, so the connection will drop briefly.",
