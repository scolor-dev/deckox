...
export const messages = {
  ja: {
    common: {
      ...
      adminPasswordLabel: "管理者パスワード", cancel: "キャンセル",
    },
    app: {
    ...
    layout: {
      edit: "配置を編集", done: "完了", save: "保存", reset: "おすすめの配置に戻す",
      resetConfirm: "すべてのページを、おすすめの配置に戻します。追加したページや、並べ替えた内容は失われます。",
      addWidget: "ウィジェットを追加", add: "追加", moduleOffShort: "無効", defaultSize: "標準サイズ: {size}",
      locked: "固定", newPage: "ページを追加", pageSettings: "ページの設定", pageName: "ページ名", pageKind: "ページの種類",
      pageKindHelp: "スクロールは縦に伸びます。1面は、画面に収まり、スクロールしません。",
      kindScroll: "スクロール", kindScreen: "1面(画面に収める)", screenRows: "縦の分割数", screenRowsHelp: "画面の高さを、この数の行に等分します。",
      deletePage: "このページを削除", moveEarlier: "前へ", moveLater: "後ろへ", width: "幅", height: "高さ", heightAuto: "自動",
      configure: "設定", removeWidget: "ウィジェットを削除", emptyPage: "このページにはウィジェットがありません。",
      unknownWidget: "不明なウィジェットです({id})。", moduleOff: "{name}は、無効なモジュールを使うため、表示できません。",
      widgetFailed: "{name}を表示できませんでした。",
      serverNewer: "サーバーに、より新しい配置があります。この端末の配置が優先されています。", useServer: "サーバーの配置を使う",
      serverSaveFailed: "サーバーに保存できませんでした。この端末には保存されています。",
    },
    nav: { overview: "概要", services: "サービス", software: "ソフトウェア", storage: "ストレージ", diagnostics: "診断", audit: "監査ログ", maintenance: "保守", settings: "設定" },
    ...
    software: {
      title: "ソフトウェア", subtitle: "インストール・削除・更新を管理します。自分で入れたソフトウェアは自動で対象になり、それ以外はパッケージ名を指定して追加できます。",
      ...
      installed: "インストール済み", notInstalled: "未インストール", upgradable: "更新あり", autoDetected: "自動検出", bundleCount: "関連 {count}件", expandBundle: "{name} の関連パッケージを開く", collapseBundle: "{name} の関連パッケージを閉じる",
    ...
    errors: {
      ...
      jobLost: "操作の結果を確認できませんでした。Agentが再起動した可能性があります。状態を更新して確認してください。", jobTimeout: "操作が時間内に終わりませんでした。状態を更新して確認してください。",
    ...
    jobs: {
      ...
      kind: { software_action: "ソフトウェアの操作", service_action: "サービスの操作", schedule_run: "スケジュール実行" },
    },
  ...
  en: {
    common: {
      ...
      adminPasswordLabel: "Administrator password", cancel: "Cancel",
    },
    app: {
    ...
    layout: {
      edit: "Edit layout", done: "Done", save: "Save", reset: "Restore recommended layout",
      resetConfirm: "This restores every page to the recommended layout. Pages you added and changes you made are lost.",
      addWidget: "Add widget", add: "Add", moduleOffShort: "Off", defaultSize: "Default size: {size}",
      locked: "Locked", newPage: "Add page", pageSettings: "Page settings", pageName: "Page name", pageKind: "Page type",
      pageKindHelp: "Scrolling grows downwards. A single screen fits the window and never scrolls.",
      kindScroll: "Scrolling", kindScreen: "Single screen (fits the window)", screenRows: "Rows", screenRowsHelp: "The window height is divided evenly into this many rows.",
      deletePage: "Delete this page", moveEarlier: "Move earlier", moveLater: "Move later", width: "Width", height: "Height", heightAuto: "Auto",
      configure: "Configure", removeWidget: "Remove widget", emptyPage: "This page has no widgets.",
      unknownWidget: "Unknown widget ({id}).", moduleOff: "{name} cannot be shown because a module it needs is switched off.",
      widgetFailed: "{name} could not be shown.",
      serverNewer: "The server has a newer layout. This browser's layout is being used.", useServer: "Use the server's layout",
      serverSaveFailed: "Could not save to the server. It is saved in this browser.",
    },
    nav: { overview: "Overview", services: "Services", software: "Software", storage: "Storage", diagnostics: "Diagnostics", audit: "Audit log", maintenance: "Maintenance", settings: "Settings" },
    ...
    software: {
      title: "Software", subtitle: "Manage install, removal, and upgrades. Software you installed yourself is managed automatically; anything else can be added by package name.",
      ...
      installed: "Installed", notInstalled: "Not installed", upgradable: "Update available", autoDetected: "Auto-detected", bundleCount: "{count} related", expandBundle: "Show packages bundled with {name}", collapseBundle: "Hide packages bundled with {name}",
    ...
    errors: {
      ...
      jobLost: "The result of the operation could not be read. The Agent may have restarted; refresh to check.", jobTimeout: "The operation did not finish in time. Refresh to check.",
    ...
    jobs: {
      ...
      kind: { software_action: "Software action", service_action: "Service action", schedule_run: "Scheduled run" },
    },
