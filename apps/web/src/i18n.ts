...
export const messages = {
  ja: {
    ...
    overview: {
      ...
      read: "読込", write: "書込", hostTotal: "ホスト全体", disk: "ディスク使用率", temperature: "CPU温度", temperatureChart: "CPU温度の推移", notAvailable: "取得できません", sensorValue: "センサー取得値", perSecond: "{value}/秒",
  ...
  en: {
    ...
    overview: {
      ...
      read: "Read", write: "Write", hostTotal: "Host total", disk: "Disk usage", temperature: "CPU temperature", temperatureChart: "CPU temperature history", notAvailable: "Unavailable", sensorValue: "Sensor reading", perSecond: "{value}/s",
