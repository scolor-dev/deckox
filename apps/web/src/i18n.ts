...
export const messages = {
  ja: {
    ...
    errors: {
      ...
      serviceAction: "サービス操作に失敗しました。", serviceLogs: "サービスログを取得できませんでした。", schedules: "スケジュールの操作に失敗しました。", storage: "ストレージ情報を取得できませんでした。", password: "パスワードを変更できませんでした。",
  ...
  en: {
    ...
    errors: {
      ...
      serviceAction: "The service operation failed.", serviceLogs: "Could not load service logs.", schedules: "The schedule operation failed.", storage: "Could not load storage information.", password: "Could not change the password.",
