...
export const messages = {
  ja: {
    ...
    software: {
      ...
      installedTitle: "このホストにインストール済み", installedHelp: "パッケージマネージャーが報告しているインストール済みの全パッケージを読み取り専用で表示します。管理に追加したものだけがDeckoxから操作できます。",
      installedShow: "一覧を表示", installedHide: "一覧を閉じる", installedSearch: "インストール済みパッケージを検索", installedSearchPlaceholder: "パッケージ名で検索(例: docker)",
  ...
  en: {
    ...
    software: {
      ...
      installedTitle: "Installed on this host", installedHelp: "Every package the package manager reports as installed, shown read-only. Only packages you add to management can be acted on from Deckox.",
      installedShow: "Show list", installedHide: "Hide list", installedSearch: "Search installed packages", installedSearchPlaceholder: "Search by package name (e.g. docker)",
