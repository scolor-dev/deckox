...
export const messages = {
  ja: {
    ...
    software: {
      ...
      loading: "ソフトウェア一覧を読み込んでいます…", empty: "許可リストにソフトウェアがありません。上の欄からパッケージ名を追加してください。",
  ...
  en: {
    ...
    software: {
      ...
      loading: "Loading software…", empty: "No software is allow-listed yet. Add a package name above.",
