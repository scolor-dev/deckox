...
// A native file input, styled. The browser owns the chosen-file state (a
// file input's value can't be set from script), so this emits the picked
// File rather than taking a v-model.
withDefaults(
  defineProps<{
    label: string;
    id: string;
