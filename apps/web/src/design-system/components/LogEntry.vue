...
// One journal line. Priority drives only the left accent (error/warning
// get a color; info stays neutral) — the same "encode state in form, not
// just text" rule as StateBadge. Labels arrive already formatted/translated:
// the component owns layout, not i18n or date formatting.
withDefaults(
  defineProps<{
